...
$query = sprintf("SELECT Pres, StatusTime FROM Temp_Hum_Pres  WHERE   Temp_Hum_Pres.StatusTime > DATE_SUB(NOW(), INTERVAL 48 HOUR)");
...
//schließe die Verbindung zur Datenban
$mysqli->close();
