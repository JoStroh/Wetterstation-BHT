...
$.ajax({
url : "/PHP/Windgeschwindigkeit.php",
type : "GET",
...
const speed_Chart_obj = document.getElementById('speed_Chart').getContext("2d");

// Definition des Diagramms 
var chart = new Chart(speed_Chart_obj,{
    type: 'line',
    data:{
