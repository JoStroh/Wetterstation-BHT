...
<div class="data_container">
    ...
    <div class="chart">
        ...
        <canvas id="Regen_Chart" ></canvas>
        <p>Niederschlagsmittelwerte aufgenommen in einem 5 min Intervall und visualisiert als Summen der einzelnen Regenereignisse </p>

        <!--Verlinkung der für das Diagramm genutzten Daten-->
        <P><a href="/PHP/Regen.php"> ->Daten abrufen</a></P>
    </div>
    ...
    <div class="Textbox">
        ...
        <p><?php include('PHP/Rain_daily.php') ?></p> 
    </div>  

    <!--Einbinden des JavaScript-Skriptes für die Darstellung der Diagramme-->
    <script src="JavaScript/Regen-chart.js"></script>
