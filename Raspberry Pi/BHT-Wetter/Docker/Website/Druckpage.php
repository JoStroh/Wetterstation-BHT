...
<div class="data_container">
    ...
    <div class="chart">
        ...
        <canvas id="Druck_Chart" ></canvas>
        <p>Luftdruckmittelwerte aufgenommen in einem 5 min Intervall </p>

        <!--Verlinkung der für das Diagramm genutzten Daten-->
        <P><a href="/PHP/Druck.php"> ->Daten abrufen</a></P> 
    </div>

    <!--Einbinden des JavaScript-Skriptes für die Darstellung der Diagramme-->
    <script src="JavaScript/Druck-chart.js"></script>
