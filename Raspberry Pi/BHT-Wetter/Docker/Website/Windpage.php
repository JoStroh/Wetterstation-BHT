...
<div class="data_container">
    ...
    <div class="chart">
        ...
        <p> Windgeschwindigkeitsmittelwerte aufgenommen in einem 5 min Intervall</p>

        <!--Verlinkung der für das Diagramm genutzten Daten-->
        <P><a href="/PHP/Windgeschwindigkeit.php"> ->Daten abrufen</a></P>
    </div>
    
    <!--Visualisierung der Dynamaischen PHP-Texte-->
    <div class="Textbox">
        <h3>Windböen Tageswerte</h3>

        <!--Einbinden der PHP-Seite in die Darstellungsseite-->
        <p><?php include('PHP/Böen.php') ?></p>

        <h3>Windrichtung</h3>

        <!--Einbinden der PHP-Seite in die Darstellungsseite-->
        <p><?php include('PHP/Windrichtung_aktuell.php') ?></p> 
    </div>    
</div>    

<!--Einbinden des JavaScript-Skriptes für die Darstellung der Diagramme-->
<script src="JavaScript/Windspeed-chart.js"></script>
